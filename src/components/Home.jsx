...
import CVTamara from '../images/Resume-Tamara-2021.pdf'
...
const Home = () => {
    ...
    //     ],
    //     from: { opacity: 0, color: 'red', fontSize: '50px' },
    // })
    ...
    const { freq, factor, scale, opacity } = useSpring({
        reverse: open,
        from: { factor: 10, opacity: 0, scale: 0.9, freq: '0.0095, 0.0' },
    ...
    return (
        <Fragment>
            <div className='home'>
                <div className='home__hello' style={{ display: 'flex', justifyContent: 'center', height: '200px' }} onClick={() => toggle(!open)}>
                ...
                <div className='home__cv' >
                    <a href={CVTamara} target="blank">
                        <Button type='primary' >Ver Curriculum</Button>
                    </a>
                </div>
